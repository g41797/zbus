...
zig translate-c -lc --verbose-cimport -Isrc/c/include  -fno-emit-bin src/libs/libubox/blobmsg_json.c > src/c/libubox/blobmsg_json.zig
zig translate-c -lc --verbose-cimport -Isrc/c/include -fno-emit-bin src/libs/libubox/jshn.c > src/c/libubox/jshn.zig
